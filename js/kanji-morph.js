...
class KanjiMorph {
  ...
  prepareMorph() {
    ...
    for (let strokeIndex = 0; strokeIndex < numMax; strokeIndex++) {
      ...
      this.smoothJoinedPath(morphPath, fromStroke.segments.length - 1, 500);
...
function randomKanji() {
  return supportedKanji[Math.floor(Math.random() * supportedKanji.length)];
}
